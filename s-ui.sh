...
custom_version() {
    ...
    download_link="https://raw.githubusercontent.com/PlanetEditorX/s-ui/refs/heads/dev/install.sh"
...
update_shell() {
    wget -O /usr/bin/s-ui -N --no-check-certificate https://github.com/PlanetEditorX/s-ui/raw/main/s-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
